...
var galleryImages = [
    ...
    { path: `${galleryPaths.culture}/leipzig/image12.jpeg`, description: "Panoramic Beauty: Soak in breathtaking views of Leipzig, blending history and modern charm from atop the monument! 🌄🏙️" },
    { path: `${galleryPaths.culture}/leipzig/image13.jpeg`, description: "Innovative Excellence: Witness cutting-edge automotive production at the BMW factory, where precision meets innovation! 🚗🏭✨" },
    ...
    { path: `${galleryPaths.practice}/week_two/image6.jpeg`, description: "Smart Living: Effortlessly configure your Loxone Miniserver to automate alarms, set custom lighting moods, and control heating or cooling based on temperature sensors for a truly intelligent home! 🏡⚙️💡🌡️" },
    { path: `${galleryPaths.practice}/week_two/image7.jpeg`, description: "Surprised Reaction: Witness a friend’s shocked expression as they look at the Loxone Miniserver, realizing the complexity and capabilities of automating their smart home! 😲⚙️🏡" },
    { path: `${galleryPaths.practice}/week_two/image8.jpeg`, description: "🎮✨ Creating a vibrant game in Stencyl using Flash technology for interactive fun, diving into a colorful world where creativity knows no bounds, unleashing imagination with captivating gameplay, experiencing fast-paced action and stunning graphics, and embarking on an adventure with smooth animations! 🌈🚀🌟💥🕹️" },
